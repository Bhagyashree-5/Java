...
public class StatementProg {
	...
	public static void main(String[] args) {
		try {
			...
			conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/test", "bhagyashree", "Bhagyashree07");
			StatementProg prg = new StatementProg();
			do {
